...
// TestListAccountsAPI tests the listAccounts API using mock database.
...
// requireBodyMatchAccounts checks if the response body matches the given list of accounts.
