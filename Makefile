postgres:
	docker run -h postgres-server --name postgres-server --network bank-network -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=password -d postgres:15-alpine3.16
