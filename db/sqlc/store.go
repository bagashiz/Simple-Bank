...
// It creates a transfer record, add account entries, and updates account balances within a database transaction
...
// addMoney adds money to an account within a database transaction
func addMoney(
	ctx context.Context,
	q *Queries,
	accountID1 int64,
